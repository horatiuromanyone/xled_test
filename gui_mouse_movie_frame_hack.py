...
I start a realtime mode on the xled device, and I update each frame with a frame out of a movie that I rip in python
we send a full frame of images to the twinkly, it doesn't save the movie on the device.
"""
